                ...
                <form method="post" action="/results">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="condition" id="condition" class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
                            <option value="Placeholder" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" name="condition">Choose a Condition</option>
                            <c:forEach var="ad" items="${ads}">
...
<%--        <c:forEach var="ad" items="${ads}">--%>
            <div class="flex justify-center">
                    ...
                    <h3 class = "text-gray-500"><a href="/ad-details?id=${ad.id}&userId=${ad.userId}" >${ad.title}</a></h3>
                    <p class="mb-2 text-base text-neutral-600 dark:text-neutral-200">Car for Sale
                    </p>
                    ...
                    <p class="mb-2 text-base text-neutral-600 dark:text-neutral-200">
                        need $10000 Lorem ipsum dolor sit amet, consectetur adipisicing elit. A doloribus laudantium natus officiis quaerat qui reprehenderit soluta unde! Dolores enim est impedit, molestias nulla quam quis saepe ut vitae voluptatem!
                    </p>
                    </div>
